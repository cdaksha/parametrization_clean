...
def test_double_pareto_1(uniform_mock, get_individuals, double_pareto_params):
    ...
    child1, child2 = DoubleParetoCross.crossover(parent1, parent2, dpx_alpha=alpha, dpx_beta=beta)
...
@patch('random.uniform')
@pytest.mark.usefixtures('get_individuals')
def test_double_pareto_2(uniform_mock, get_individuals, double_pareto_params):
    alpha, beta = double_pareto_params
